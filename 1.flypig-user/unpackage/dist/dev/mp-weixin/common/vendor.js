...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"feizhulvyou","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 108:
/*!***********************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/github/2.云开发飞猪旅游(小程序云开发前后端)/flypig-user/common/erring.js ***!
  \***********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.erring = void 0; // 错误提示
// 身份证正则
var idcardReg = /^[1-9]\d{7}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}$|^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}([0-9]|X)$/;

var erring = function erring(name, phone, carded) {
  return new Promise(function (resolve, reject) {
    // 请填写姓名
    if (name == '') {
      console.log('请填写姓名');
...
};exports.erring = erring;

/***/ }),

/***/ 109:
/*!**********************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/github/2.云开发飞猪旅游(小程序云开发前后端)/flypig-user/common/wxpay.js ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.wxpay = void 0; // 微信支付
var wxpay = function wxpay(wxData) {
  return new Promise(function (resolve, reject) {
...
/***/ 12:
/*!*******************************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/github/2.云开发飞猪旅游(小程序云开发前后端)/flypig-user/node_modules/animate.css/animate.css ***!
  \*******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 13:
/*!***************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/github/2.云开发飞猪旅游(小程序云开发前后端)/flypig-user/pages/store/store.js ***!
  \***************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
new _vuex.default.Store({
  ...
  actions: {
    // 描点链接
    navdata: function navdata(navact, index) {
      navact.commit('indexmuta', index);
    } },

  mutations: {
    // 描点链接
    indexmuta: function indexmuta(state, index) {
      state.navindex = {
        index: index };
    ...
    // 发帖页面选择城市的值
    travemuta: function travemuta(state, traveion) {
      state.travecity = {
        traveing: traveion };

    },
    // tab点击切换的值
    listmuta: function listmuta(state, listion) {
      state.list = {
        listing: listion };

    },
    // tab切换的loading值
    loadmuta: function loadmuta(state, loadion) {
      state.load = {
        loading: loadion };
...
/***/ 21:
/*!*************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/github/2.云开发飞猪旅游(小程序云开发前后端)/flypig-user/common/cloudfun.js ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.homelist = exports.home = void 0;var db = wx.cloud.database();

// 并发请求轮播，tab数据
var home = function home(banner) {
  return new Promise(function (resolve, reject) {
    var banners = db.collection(banner);
    banners.get().
    then(function (res) {
      // console.log(res)
      resolve(res);
...
// 请求第一个tab的列表数据
exports.home = home;var homelist = function homelist(listing, typedatas, pageid) {
  return new Promise(function (resolve, reject) {
...
/***/ 30:
/*!*********************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/github/2.云开发飞猪旅游(小程序云开发前后端)/flypig-user/common/list.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.login = exports.addressdata = exports.preview = void 0; // 引入定位js
var QQMapWX = __webpack_require__(/*! ../common/qqmap-wx-jssdk.min.js */ 31);
var qqmapsdk;


// 封装公用预览图片
var preview = function preview(index, imglist) {
  return new Promise(function (resolve, reject) {
    uni.previewImage({
      current: index,
      urls: imglist,
...
// 公用定位
exports.preview = preview;var addressdata = function addressdata() {
  return new Promise(function (resolve, reject) {
    // 实例化API核心类
...
// 公用登录
exports.addressdata = addressdata;var login = function login(user) {
  return new Promise(function (resolve, reject) {
    console.log(user);
...
/***/ 31:
/*!***********************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/github/2.云开发飞猪旅游(小程序云开发前后端)/flypig-user/common/qqmap-wx-jssdk.min.js ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 5:
/*!*****************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/github/2.云开发飞猪旅游(小程序云开发前后端)/flypig-user/pages.json ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 59:
/*!*********************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/github/2.云开发飞猪旅游(小程序云开发前后端)/flypig-user/common/util.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
