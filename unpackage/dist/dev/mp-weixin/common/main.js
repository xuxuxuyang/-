...
var loader = function loader() {__webpack_require__.e(/*! require.ensure | element/loading */ "element/loading").then((function () {return resolve(__webpack_require__(/*! ./element/loading.vue */ 121));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('loader-list', loader); // 引入单页面loading组件
var homeload = function homeload() {__webpack_require__.e(/*! require.ensure | element/homeload */ "element/homeload").then((function () {return resolve(__webpack_require__(/*! ./element/homeload.vue */ 128));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('home-load', homeload); // 引入没有数据提示的组件
var nonedata = function nonedata() {__webpack_require__.e(/*! require.ensure | element/none */ "element/none").then((function () {return resolve(__webpack_require__(/*! ./element/none.vue */ 135));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('none-data', nonedata); // 引入购物车loading组件
var samllload = function samllload() {__webpack_require__.e(/*! require.ensure | element/smallload */ "element/smallload").then((function () {return resolve(__webpack_require__(/*! ./element/smallload.vue */ 142));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};_vue.default.component('samll-load', samllload); //引入vuex文件
